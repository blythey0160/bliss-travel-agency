...
== Changelog ==
== 1.0.9 ==
* Fixed Single Trip Days Output display.
* Fixed layout for Demo Importer plus.

== 1.0.8 ==
* Fixed Single trip gallery compatibility with latest version of WPTE.

== 1.0.7 =
* Added Getting Started page

== 1.0.6 =
* Updated site footer layout
* Fixed Trip Page Notice error
* Fixed CSS styling issues for site footer and trip pagination
* Added filters for header, footer and sidebar
* Updated list of pro templates
* Required PHP version is 7.4 now from 5.6
